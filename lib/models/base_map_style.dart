...
///
/// On a freshly pushed route (RecordScreen from the home record / locate
/// buttons) the controller is often not laid out on the first frame — a
/// single kick silently no-ops and the map stays white. Retries with backoff
/// until the camera is attached or [maxAttempts] is exhausted.
