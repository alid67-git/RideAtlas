...
/// Opens the OS file picker for GPX/KML/KMZ import (one file, or several at
/// once with [allowMultiple]).
///
/// Filtering by extension differs by platform on purpose:
/// - Android's MimeTypeMap often has no entry for "gpx", and the system
///   document picker then hides those files entirely instead of just
///   failing to match them - so on Android we request [FileType.any] and
///   validate the extension ourselves afterwards (see
///   [isSupportedTrackFileName]).
