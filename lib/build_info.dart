...
const String kAppBuildLabel = 'v1.4.109 beta';

/// Shown once, in a dialog, the first time this build label is seen.
const String kAppBuildNote =
    'Kayıt ve konum tuşunda beyaz ekran: ana haritadan konum aktarımı, '
    'onMapReady + gecikmeli karo, TileLayer yeniden bağlama.';
