...
const String kAppBuildLabel = 'v1.4.79 beta';

/// Shown once, in a dialog, the first time this build label is seen.
const String kAppBuildNote =
    'Yeni iz yüklenince haritada gösterilir; tek iz tüm pencereye, '
    'birden fazla iz birlikte sığacak şekilde otomatik yakınlaştırılır.';
