...
const String kAppBuildLabel = 'v1.4.47 beta';

/// Shown once, in a dialog, the first time this build label is seen.
const String kAppBuildNote =
    'Topo haritası renkli OpenTopoMap stiline döndü - yükseklik yeşil/'
    'sarı/kahverengi tonlarıyla okunuyor (önceki soluk Esri topo yerine).';
